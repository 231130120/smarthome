...
#define API_KEY "AIzaSyBsKaCvwyXHEzBj5oSQJY9kAee0hRxOxTE"    //Found in Project Settings > General
#define DATABASE_URL "https://test-16207-default-rtdb.asia-southeast1.firebasedatabase.app/"  //From Realtime Database URL
#define USER_EMAIL "fernando@gmail.com"  //email user saat membuat database
#define USER_PASSWORD "fernando123"          //password user yang telah didaftarkan
